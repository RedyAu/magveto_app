                                ...
                                child: Row(
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      color: Colors.amber,
                                      onPressed: newPlayerNameController
                                              .text.isEmpty
                                          ? null
                                          : () {
                                              setState(() {
                                    ...
                                    IconButton(
                                        ...
                                        color: Colors.amber,
                                        onPressed: () =>
                                            newPlayerNameFocusNode.nextFocus())
                                  ],
                                ),
                              ),
                            ),
                                      ...
                                      for (var player in players) {
                                        ...
                                        if (emptyTeams.isNotEmpty) {
                                          ...
                                          var singlePlayerTeams = teams
                                              .where((t) => t.playerCount == 1)
                                              .toList();
                                          if (singlePlayerTeams.isNotEmpty) {
                                            singlePlayerTeams[Random().nextInt(
                                                    singlePlayerTeams.length)]
                                                .characters[1]
                                                .player = player;
                                          }
                                        }
                          ...
                          itemBuilder: (context, index) {
                            return DragTarget<Player>(
                              onWillAccept: (candidateData) {
                                if (teams[index].playerCount >= 2) return false;
                                return true;
                              },
                              onAccept: (e) {
                                setState(() {
                                  if (teams[index].characters[0].player == null)
